package com.example.springshiyan5.config;

import com.example.springshiyan5.service.impl.UserDetailsServiceImpl;
...
//                .withUser("aaa").password("111").authorities("USER")
//                .and()
